...
We can count how many words a child hears and express this as a rate [e.g., words per hour; @cristia2020accuracy], and we can similarly estimate how many words they know [e.g., by parents' reports of vocabulary size, @wordbankbook]. 
