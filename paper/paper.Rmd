...
These models also estimate a latent language ability for each child in the dataset. 
However, this ability is no doubt correlated with age, sex (females have larger vocabularies at young ages), and likely with features related to input quality. 
