...
**Beyond vocabulary**. The "standard model" that we have proposed is a model of the accumulation of words, but language is a rich, complex system in which words are inflected morphologically and composed syntactically to express compositional meanings. 
