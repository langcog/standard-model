...
As covariates we included the lexical class of each word (function words, adjective, noun, verb, or other), and the estimated numbers of tokens per word a child is likely to hear each month (range: 0.2 - 19,286 tokens), based on estimates from the CHILDES corpus of child-directed speech [@macwhinney2000childes]. 
